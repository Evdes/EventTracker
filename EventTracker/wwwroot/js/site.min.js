$(document).ready(function(){function n(){if($(".timeframes").length>1){var n="#Timeframe_"+$(this).data("id");$(n).remove()}}$(".deleteTimeframeButton").click(n);$("#addTimeframe").click(function(t){var i,r,u;t.preventDefault();i=$(".timeframes").length;r=`
