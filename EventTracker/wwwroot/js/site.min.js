$(document).ready(function(){function n(){if($(".timeframes").length>1){var n="#Timeframe_"+$(this).data("id");$(n).remove()}}$(".DeleteTimeframeButton").click(n);$("#addTimeframe").click(function(t){var i,r,u;t.preventDefault();i=$(".timeframes").length;r=`<div class="timeframes" id="Timeframe_`+i+`">
            ...
            </div>`;$("#TimeFramesToAdd").append(r);u=$("#DeleteTimeframeButton_"+i);u.click(n)})});