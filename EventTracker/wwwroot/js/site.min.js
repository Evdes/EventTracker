$(document).ready(function(){function n(){if($(".timeframes").length>1){var n="#Timeframe_"+$(this).data("id");$(n).remove()}}$(".btn-delete-timeframe").click(n);$("#addTimeframe").click(function(t){var i,r,u;t.preventDefault();i=$(".timeframes").length;r=`
            ...
            <div><span class="field-validation-valid" data-valmsg-for="Timeframes[`+i+`].Endtime" data-valmsg-replace="true"></span></div>`;$("#TimeFramesToAdd").append(r);u=$("#DeleteTimeframeButton_"+i);u.click(n)});$(".toggle-password").click(function(){$(this).children().toggleClass("fa-eye fa-eye-slash");var n=$(this).parent().siblings(".password");n.attr("type")=="password"?n.attr("type","text"):n.attr("type","password")});$(".alert-dismissible").fadeTo(3e3,500).slideUp(500,function(){$(".alert-dismissible").alert("close")})});